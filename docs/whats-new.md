...
### Feat
- moved from `OPeNDAP` to `copernicus-marine-client` in `dfmt.download_CMEMS()` by [@veenstrajelmer](https://github.com/veenstrajelmer) in [#691](https://github.com/Deltares/dfm_tools/pull/691)
