...
Report bugs at https://github.com/openearth/dfm_tools/issues.
...
dfm_tools could always use more documentation, whether as part of the
official dfm_tools docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/openearth/dfm_tools/issues.
...
Ready to contribute? Here's how to set up `dfm_tools` for local development.

1. Fork the `dfm_tools` repo on GitHub.
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.org/openearth/dfm_tools/pull_requests
