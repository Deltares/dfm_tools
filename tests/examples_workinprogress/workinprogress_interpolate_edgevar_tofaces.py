...
#varn_fec = mesh2d_var.attrs['face_edge_connectivity']
...
edgevar_tofaces_onint_step1 = uds[varn_onedges].isel({dimn_edges:data_fec}) #TODO: fails for cb_3d_map.nc, westernscheldt
