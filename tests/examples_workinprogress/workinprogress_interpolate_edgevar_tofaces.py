...
if 'mesh2d_vicwwu' in uds.data_vars:
    ...
    raise KeyError(f'vars not available, choose different one from:\n{uds_edges}')
...
edgevar_tofaces_step1 = uds[varn_onedges].isel({uds.grid.edge_dimension:data_fnc}) #TODO: fails for cb_3d_map.nc
