...
from dfm_tools.get_nc_helpers import get_ncvardimlist, get_timesfromnc
...
vars_pd = get_ncvardimlist(file_nc=file_nc)
...
for sub in subs:    
    #get data to plot
    data_frommap = get_ncmodeldata(file_nc=file_nc, varname=sub, timestep=0, layer=None, multipart=True)
