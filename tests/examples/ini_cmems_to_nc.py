...
pathBase  = r'p:\i1000668-tcoms\03_newModel\01_input\02_bnd\CMEMS\download\data' #folder containing CMEMS so and thetao netcdf files

dir_out = '.'

file_nc_list_so = glob.glob(f'{pathBase}\\so_*.nc')
file_nc_list_thetao = glob.glob(f'{pathBase}\\thetao_*.nc')
