...
#data_xyn2 = hcdfm.xyn.models.XYNModel(Path(file_xyn)) #TODO: add to init file or expose otherwise (is in main branch now)
#data_xyn2.save(file_xyn.replace('_obs.xyn','_out_obs.xyn')) #works as expected
#data_xyn2_pd = dfmt.pointlike_to_DataFrame(data_xyn2) #works as expected
