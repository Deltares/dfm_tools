...
- [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/openearth/dfm_tools/HEAD) to run notebooks interactively (loading takes quite a while, then navigate to the notebooks folder)
