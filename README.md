...
- to get started:
	- [pdf with dfm_tools features and examples](https://github.com/openearth/dfm_tools/blob/master/docs/dfm_tools.pdf) (or [download it](https://github.com/openearth/dfm_tools/raw/master/docs/dfm_tools.pdf))
